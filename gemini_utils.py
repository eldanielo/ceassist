...
- `provide_tip`: Identify a key customer statement and suggest a specific question or topic the CE should raise. The tip should be short, actionable, and keyword-based. For the longer version, structure your response using Markdown with two distinct sections: `### Follow-up Questions` and `### Key Talking Points`. Under `Follow-up Questions`, provide a bulleted list of 1-3 specific questions the CE can ask verbatim. Under `Key Talking Points`, provide a *concise* explanation (3-4 sentences or a short bulleted list).
